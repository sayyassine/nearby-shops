    ...
    <div class="container">
        ...
        <b-card class="p-0 my-4" body-class="p-0">
                        ...
                        <b-dropdown id="dropdown-form" variant="primary" dropleft ref="dropdown" class="m-2">
                            ...
                            <b-dropdown-form>
                                ...
                                <b-input-group class="my-2 wide" append="KM"  >
                                    <b-form-input :disabled="location === null" v-model="max_distance" placeholder="Maximal Distance" type="number" ></b-form-input>
                                </b-input-group>
            ...
            <div class="container px-5 pb-3">
                ...
                <div class="alert alert-danger mt-3" v-else-if="location === null" ><b>We couldn't get your location</b> : Ordering by distance is not available</div>
                ...
                <div class="row">
                    <store :object="st" :distance="null" :key="st.id" v-for="st in stores"
                           v-on:unlike="get_stores"
                           v-on:dislike="get_stores"
                    >
                    </store>
    ...
    export default {
        ...
        methods : {
            get_stores(){
                ...
                this.loading = true ;
                this.$axios.post("/stores/liked" ,data ).then(
                    response => {
                        if(!response.data.error){
                            ...
                            //storing last filters applied to be display filters
        ...
        data : function () {
            return {
                ...
                page : 1 ,
                item_per_page : 20,
                // count of all the results matching the filter (used to calculate page count)
                results_count : 0,
                //store type filter value
                type : 0,
        ...
        computed : {
            ...
            // calculate the count of stores displayed actually
            results_in_page(){
